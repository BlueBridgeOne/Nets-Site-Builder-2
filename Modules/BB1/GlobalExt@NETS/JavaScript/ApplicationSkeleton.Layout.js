	...
	,	showContent: function (view, dont_scroll)
		{
			...
			//document's title
			document.title = (view.title || '')+" | NETS | Quality Parts - Driven by Service";
	...
	,	addModalListeners: function (view)
		{
			...
			view.$containerModal.on('hidden.bs.modal', function ()
			{
				...
				document.title = (self.currentView && self.currentView.getTitle() || '')+" | NETS | Quality Parts - Driven by Service";
			});
